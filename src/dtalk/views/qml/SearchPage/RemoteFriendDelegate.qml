        ...
        Item {
			...
			Rectangle {
				...
				Widgets.LayoutText {
                    ...
                    maxWidth: container.width - faceImage.width - addButton.width - container.margins * 3
            ...
            Widgets.DButton {
                ...
                anchors.verticalCenter: parent.verticalCenter
                source: "qrc:/images/common/add_friend.png"
                
                onClicked: {
                    wrapper.ListView.view.model.doAddClicked(index)
                }
            }
